...
function GetStarted2(){
    ...
    <div className="input-template">
        ...
        <div className="input-wrapper">
    <input type="location" placeholder="" id="hair-dresser-email-id" recquired name="location" className="standard-first-input"/>
...
<div className="input-wrapper">
    ...
    <button  className="nxt-btn-input-1">Next</button>
    </form>
...
function GetStarted(){
   ...
   <section className="getStarted-main-frame">
    ...
    <div className="main-frame-2">
        <GetStarted1 value={{feedBackChannel:getDataFromGetStarted1}}/>
